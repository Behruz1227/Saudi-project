...
const AccardionOpen = ({ rote, stops,landmarks,backstops }) => {
    ...
    <div className='w-100% mx-auto h-[20rem] overflow-y-auto scroll-style mediaAccardion gap-10'>
      <div className='acardion-flex'>
        <div className='flex w-100% mb-5'>
          ...
          <div className='block w-100%'>
            <h3 className='font-semibold accardionH3'>{rote[0] && rote[0].from}</h3>
            <p className={styles.pargStyle}>
              {rote[0] && rote[0].fromAndToLocation}
            </p>
          </div>
        </div>
      ...
      <div className='acardion-flex'>
        <div className='flex w-100% mb-5'>
          <img src={accardion1} alt="accardion image" className='mx-3' />
          <div className='block w-100%'>
            <h3 className='font-semibold accardionH3'>{rote[0] && rote[0].to}</h3>
            <p className={styles.pargStyle}>
              {rote[0] && rote[0].toAndFromLocation}
            </p>
          </div>
        </div>
        <div className='list-map'>
          <Chupah2  stops={backstops} />
        </div>
      </div>
      <div className='acardion-flex'>
        <div className='flex w-100% mb-5'>
