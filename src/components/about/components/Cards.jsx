...
import bussVedio from "../../../assets/vedio-bus.mp4";
  ...
  return (
    ...
    <div className="max-w-[1100px] flex flex-col mx-auto about-cards-main">
      ...
      <div className="flex justify-between items-start mt-10 about-cards-box">
        <div className="aboutCard1 rounded-2xl px-6 py-7 w-1/3 h-96 mx-4 shadow-lg hover:bg-slate-100 hover:-mt-2 relative ml-0">
        ...
        <div className="aboutCard2 rounded-2xl px-6 py-7 w-1/3 h-96 mx-2 shadow-lg hover:bg-slate-100 hover:-mt-2 relative">
        ...
        <div className="aboutCard3 rounded-2xl px-6 py-7 w-1/3 h-96 mx-4 shadow-lg hover:bg-slate-100 hover:-mt-2 relative mr-0">
      ...
      <div className="mt-16">
        ...
        <video src={bussVedio} loop autoPlay className="w-full object-cover"></video>
      </div>
    </div>
    // </div>
  )
